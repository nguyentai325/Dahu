...
int main(int argc, char** argv)
{
  ...
  std::string inputDirectory1 = "/home/minh/Documents/code/code_edwin/build/apps/fastmbd/dahu_thresh";
  std::string outputDirectory = "/home/minh/Documents/code/code_edwin/build/apps/fastmbd/dahu_thresh_saliency";
  ...
  while((_dirent = readdir(directory)) != NULL)
  {
    ...
    if ((std::string(_dirent->d_name) != ".") and (std::string(_dirent->d_name) != "..") )
    {
        ...
        std::string fileName_seed = inputDirectory1 + "/" +std::string(_dirent->d_name);
          ...
          image2d<uint8_t> image_seed_gray;
          io::imread(fileName_seed.c_str(),image_seed_gray);
...
//          }
          ...
          tree_t T;
          {
            ...
            */
            ...
            io::imsave(distancemap_final_gray, fileName.c_str());
