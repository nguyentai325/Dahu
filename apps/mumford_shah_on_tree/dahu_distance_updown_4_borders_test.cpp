...
namespace mln
{
	...
	{
		if (p[0] == 2 and p[1] != 0  and p[1]  != 1 and p[1]  != width - 1 and p[1] != width -2)
			return true;
		else 
			return false;
	...
	{
		if (p[0] == height -3  and p[1] != 0  and p[1]  != 1 and p[1]  != width - 1 and p[1] != width -2 )
			return true;
		else 
			return false;
	...
	{
		if (p[1] == 2 and p[0] != 0  and p[0]  != 1  and p[0] != height -1 and p[0] != height -2)
			return true;
		else 
			return false;
	...
	{
		if (p[1] == width - 3 and p[0] != 0  and p[0]  != 1  and p[0] != height -1 and p[0] != height -2 )
			return true;
		else 
			return false;
...
int main(int argc, char** argv)
{
  ...
  std::string inputDirectory = "/home/minh/Documents/code/code_edwin/program/apps/mumford_shah_on_tree/resize";
  std::string outputDirectory = "/home/minh/Documents/code/code_edwin/program/apps/mumford_shah_on_tree/Dahu_SLIC/dahu_4_borders_out";
