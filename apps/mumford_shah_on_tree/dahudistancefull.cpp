...
int main(int argc, char** argv)
{
    ...
    std::string outputDirectory = "/home/minh/Documents/python/Evaluation/outpython/out_test_4sides";
     ...
     while((_dirent = readdir(directory)) != NULL)
    {
		...
		if ((std::string(_dirent->d_name) != ".") and (std::string(_dirent->d_name) != ".."))
		{
			...
			//cv::Mat ima = cv::imread(fileName.c_str());
			  ...
			  tree_t T;
			  {
				...
				for (unsigned k = 0; k< 4 ;++k)
				{
					...
					if (k== 1)
						io::imsave(distancemap, "dmap1.png");
					if (k== 2)
						io::imsave(distancemap, "dmap2.png");
					if (k== 3)
						io::imsave(distancemap, "dmap3.png");
					
				}
				//io::imsave(distancefinal, output_path);			
			...
			io::imsave(distancefinal, fileName.c_str()); 		
