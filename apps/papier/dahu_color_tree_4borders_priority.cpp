...
int main(int argc, char** argv)
{
  ...
  std::string outputDirectory_4_borders = "/media/minh/DATA/Study/Results/compare_boundary_4border/pascal/color";
  std::string outputDirectory_4_borders_scalar = "/media/minh/DATA/Study/Results/compare_boundary_4border/pascal/scalar";
...
//            // back propagation
            ...
            mln_foreach(auto p, dahu_4_borders.domain())
            {
                ...
                dahu_4_borders_scalar(p) = dahu_4_borders(p)[0]/3  + dahu_4_borders(p)[1]/3 +dahu_4_borders(p)[2]/3;
