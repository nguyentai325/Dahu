...
int main(int argc, char** argv)
{
  ...
  std::string outputDirectory = "/media/minh/DATA/Study/Results/compare_MBD_methods/MSRA/Dahu/color";
  std::string outputDirectory_scalar = "/media/minh/DATA/Study/Results/compare_MBD_methods/MSRA/Dahu/scalar";
